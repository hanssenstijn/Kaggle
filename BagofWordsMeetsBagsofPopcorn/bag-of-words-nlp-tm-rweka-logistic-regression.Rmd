...
- Data Import
```{r}
word_train = read.table("../input/bag-of-word-meets-bag-of-popcorn/labeledTrain.tsv", header = T)
word_test = read.table("../input/bag-of-word-meets-bag-of-popcorn/test.tsv", header = T)
